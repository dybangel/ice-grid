...
namespace autosell_center.util
{
    public class TemplateMessage
    {
        ...
        public static string SendTemplateMsg(string accessToken, string data)
        {
            ...
            Util.Debuglog("result=" + strMsg + "data=" + data, "模板消息.txt");
            return strMsg;
        }
        ...
        /// <returns></returns>
        public static string ch_error(string openID, string templateID, string title, string mechineName, string ldNO, string errType, string remark)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("{");
            sb.Append("\"touser\":\"" + openID + "\",");
        ...
        /// </summary>Wkb4oZ26VYQOXGpoSdOmcNUbY6h2kVtZAPwpmVO1fdg
        /// <param name="openID"></param>
        /// <param name="templateID"></param>
        /// <param name="title"></param>
        ...
        /// <param name="remark"></param>
        /// <returns></returns>
        public static string getProduct(string openID, string templateID, string title, string orderNO, string bh, string remark)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("{");
            sb.Append("\"touser\":\"" + openID + "\",");
            ...
            sb.Append("\"data\":{");
            sb.Append("\"first\":{\"value\":\"" + title + "\",\"color\":\"#173177\"},");
            sb.Append("\"keyword1\":{\"value\":\"" + orderNO + "\",\"color\":\"#173177\"},");
            sb.Append("\"keyword2\":{\"value\":\"" + bh + "\",\"color\":\"#173177\"},");
            sb.Append("\"remark\":{\"value\":\"" + remark + "\",\"color\":\"#173177\"}}}");
            return sb.ToString();
        }
        /// <summary>
        ...
        /// <param name="remark"></param>
        /// <returns></returns>
        public static string getPrize(string openID, string templateID, string title, string activity, string prize, string url)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("{");
            sb.Append("\"touser\":\"" + openID + "\",");
            ...
            sb.Append("\"remark\":{\"value\":\"请今天前往售奶机处购奶，享黄金会员价！点击查看会员福利 >>\",\"color\":\"#173177\"}}}");
            return sb.ToString();
        }
    }
}