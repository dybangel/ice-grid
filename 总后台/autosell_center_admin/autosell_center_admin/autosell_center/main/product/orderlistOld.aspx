<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderlistOld.aspx.cs" Inherits="autosell_center.main.product.orderlistOld" %>
<!DOCTYPE html>
                ...
                <div class="navlist">
                    <dl>
                        <dt>订单管理<em class="fa fa-cog"></em></dt>
                             <dd>
                                <a class="change" href="order.aspx" ><i class="change fa fa-window-restore"></i>订购记录</a>
                            </dd>
                             <dd>
                                <a class="change acolor" href="#" onclick="qx_judge('gmjl')"><i class="change icolor fa fa-window-restore"></i>购买记录</a>
                            </dd>
...
<script>
    ...
    function getOrderList() {
        $("#memberList").empty();
        $(" <li>"
             + " <label style='width:10%'>序号</label>"
                +"  <label style='width:10%'>订单编号</label>"
                + " <label style='width:20%'>产品名称</label>"
                + " <label style='width:8%'>单价</label>"
                
                + " <label style='width:10%'>订购/零售</label>"
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < serverdatalist; i++) {
                    ...
                    $(" <li>"
                         + "   <span style='width:10%'>" + serverdata[i].Row + "</span>"
                         + "   <span style='width:10%'>" + serverdata[i].orderNO + "</span>"
                         + "   <span style='width:20%'>" + serverdata[i].proname + "</span>"
                         ...
                         + "   <span style='width:12%'>" + serverdata[i].bz + "</span>"
                         + "</li>").appendTo("#memberList");
                }
            }
        })
