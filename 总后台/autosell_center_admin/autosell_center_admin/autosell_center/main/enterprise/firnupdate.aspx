<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="firnupdate.aspx.cs" Inherits="autosell_center.main.enterprise.firnupdate" %>
                        ...
                        <div class="addnaiq">
                            ...
                            <ul class="addnaiqdata" id="addnaiqdata1" style="display: block;">
                                  <li>
                                    <label>企业登录编号</label>
                                    <div>
                                        <input type="text" value="" placeholder="" id="bh" runat="server"/>
                                        <p>企业登录编号</p>
                                    </div>
                                </li>
                                  <li>
                                    <label>企业登录密码</label>
                                    <div>
                                        <input type="text" value="" placeholder="" id="pwd" runat="server"/>
                                        <p>企业登录密码</p>
                                    </div>
                                </li>
                                 <li>
                                    <label>企业简码</label>
                                    <div>
                                        <input type="text" value="" placeholder="" id="code" runat="server"/>
                                        <p>企业简码使用英文大写字母</p>
                                    </div>
                                </li>
                                <li>
                                    <label>企业名称</label>
                                    <div>
                                        <input type="text" value="" placeholder="" id="companyName" runat="server"/>
                                        <p>请填写企业全称</p>
                                    </div>
                                </li>
                                <li>
                                    <label>负责人</label>
                                    <div>
                                        <input type="text" value="" placeholder=""  id="fzr" runat="server"/>
                                        <p>企业负责人姓名</p>
                                    </div>
                                </li>
                                <li>
                                    <label>财务联系人</label>
                                    <div>
                                        <input type="text" value="" placeholder="" id="cwr" runat="server"/>
                                        <p>企业财务联系人姓名</p>
                                    </div>
                                </li>
                                <li>
                                    <label>联系方式</label>
                                    <div>
                                        <input type="text" value="" placeholder=""  id="phone" runat="server"/>
                                ...
                                <li>
                                    <input class="firmbtn" type="button" value="保存" onclick="upload1()" />
                                </li>
                            </ul>
                            <ul class="addnaiqdata" id="addnaiqdata2">
                                <li>
                                    ...
                                    <div>
                                        <img id="pic" src="/main/public/images/addimg.png" alt="" runat="server"/>
                                ...
                                <li>
                                    ...
                                    <div>
                                        <img id="piclogo" src="/main/public/images/addimg.png" alt=""  runat="server"/>
...
<script>
    ...
    function upload1() {
        ...
        //$.ajax({
        //    type: "post",
        //    url: "firnupdate.aspx/update",
        //    contentType: "application/json; charset=utf-8",
        //    data: "{id:'" + $("#_companyID") + "',comName:'" + comName + "'}",
        //    dataType: "json",
