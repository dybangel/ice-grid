        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string fileExtension = Path.GetExtension(FileUpload1.PostedFile.FileName).ToLower();//文件的后缀名(小写)
                                                                                                    ...
                                                                                                    //判断是否重名
                string sql = "select * from asm_video where  name='"+fileName+"'";
                ...
                if (imgfileExp.ToLower() == "flv" || imgfileExp.ToLower() == "mp4")
                {
                    ...
                    string sql2 = "insert into asm_video(description,path,name,type,companyID,size) values('" + this.description.Value + "','" + path + "','" + fileName+"" + "'," + this.videoType.SelectedValue + ",0,"+this.video_size.Value+")";
