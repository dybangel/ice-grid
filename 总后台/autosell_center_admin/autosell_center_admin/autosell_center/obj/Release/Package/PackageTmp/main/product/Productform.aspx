                ...
                <div class="common_main">
                    <div class="navlist">
                         <dl>
                            ...
                            <dd>
                                <a class="change acolor" href="Productform.aspx"><i class="change  fa fa-user"></i>商品订单统计</a>
                            </dd>
                         <dd>
                    ...
                    <section class="jiqlist">
                        ...
                        <ul class="jiqlistseach">
                            <li>
                                 <input name="act_stop_timeks" type="text" id="start"   runat="server"  class="input" value="" placeholder=""  />
                            </li>
                             <li>
                                 <input name="act_stop_timeks" type="text" id="end"   runat="server"  class="input" value="" placeholder=""  />
                            </li>
                             <li>
...
<script>
    ...
    function sear() {
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "{start:'" + $("#start").val() + "',end:'" + $("#end").val() + "',mechineID:'" + $("#mechineList").val() + "' ,pageCurrentCount:'" + $("#pageCurrentCount").val() + "',brandID:'" + $("#brandList").val() + "',companyID:'" + $("#companyList").val() + "'}",
            success: function (data) {
