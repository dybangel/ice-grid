<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="standardbzq.aspx.cs" Inherits="autosell_center.main.product.standardbzq" %>
        ...
        <div class="main">
            <div id="addCaDiv" class="addDiv change">
                ...
                <ul>
                    <li>
                        <label>排序</label>
                        <input type="text" value="" placeholder="排序" />
                    </li>
                    <li>
                        <label>保质期</label>
                        <input type="text" value="" placeholder="填写保质期，单位：天" />
                    </li>
                    <li>
                        <label></label>
            ...
            <div id="updataCaDiv" class="addDiv change">
                ...
                <ul>
                    <li>
                        <label>排序</label>
                        <input type="text" id="updateCId" value="" placeholder="排序" />
                    </li>
                    <li>
                        <label>保质期</label>
                        <input type="text" id="updateCN" value="" placeholder="填写保质期，单位：天" />
                    </li>
                    <li>
                        <label></label>
                ...
                <div class="common_main">
                    <div class="navlist">
                        ...
                        <dl>
                            ...
                            <dd>
                                <a class="change acolor"><i class="change icolor fa fa-shield"></i>产品保质期</a>
                            </dd>
                        </dl>
                    </div>
                    <section class="jiqlist">
                        <dl class="jiqlistTab">
                            <dd class="change ddcolor"><b>产品保质期</b></dd>
                        </dl>
                        <div class="addClass">
                        ...
                        <ul class="productclass">
                            <li>
                                ...
                                <label class="classname">保质期</label>
                                <label class="classdelete">操作</label>
                            </li>
                            <li>
                                <span class="classid">1</span>
                                <span class="classname">7天</span>
