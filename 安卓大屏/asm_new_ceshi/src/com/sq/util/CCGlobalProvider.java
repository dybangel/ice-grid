...
public class CCGlobalProvider extends ContentProvider {

	public static final String AUTHORITIES = "com.tools.payhelper.cache";
    public static final Uri AUTHORITY_URI = Uri.parse("content://" + AUTHORITIES + "/globalprovider");
    ...
    public static Uri save(Context context, ContentValues values) {
        return context.getContentResolver().insert(CCGlobalProvider.CONTENT_URI, values);
    }
