<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxorbalanceNew.aspx.cs" Inherits="Consumer.main.wxorbalanceNew" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div class="main" style="height:100vh;padding-bottom:10px;">
          ...
          <input type="hidden" id="_reqsn" runat="server"/>
...
<script>
    ...
    function wxpay()
    {
        ...
        var url = "wxpayNew.aspx?companyID=" + $("#_companyID").val() + "&mechineID=" + $("#_mechineID").val() + "&money=" + $("#_money").val() + "&unionID=" + $("#_unionID").val() + "&productID=" + $("#_productID").val() + "&openID=" + $("#_openID").val() + "&dgOrderDetailID=" + $("#_dgOrderID").val() + "&type=" + $("#_type").val() + "&sftj=" + $("#_sftj").val() + "&reqsn=" + $("#_reqsn").val();
        window.location.href = url;
    ...
    function balancepay()
    {
        ...
        if(confirm("将从您的余额直接扣除"))
        {
            ...
            $.ajax({
                type: "post",
                url: "wxorbalanceNew.aspx/yzPwd",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: "{unionID:'" + $("#_unionID").val() + "',money:'" + $("#_money").val() + "',companyID:'" + $("#_companyID").val() + "',productID:'" + $("#_productID").val() + "',mechineID:'" + $("#_mechineID").val() + "',type:'" + $("#_type").val() + "',dgOrderDetailID:'" + $("#_dgOrderID").val() + "',sftj:'" + $("#_sftj").val() + "',reqsn:'" + $("#_reqsn").val() + "'}",
