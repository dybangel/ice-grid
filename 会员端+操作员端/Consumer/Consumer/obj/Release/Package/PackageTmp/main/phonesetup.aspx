<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phonesetup.aspx.cs" Inherits="Consumer.main.phonesetup" %>
...
<script>
    ...
    function inputok() {
        ...
        $.ajax({
            type: "post",
            url: "phonesetup.aspx/setupOk",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "{phone:'" + $("#phone").val() + "',memberID:'" + $("#member_ID").val() + "'}",
