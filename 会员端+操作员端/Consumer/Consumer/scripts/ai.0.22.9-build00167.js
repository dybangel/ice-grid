    ...
    (function (ApplicationInsights) {
        ...
        var UrlHelper = (function () {
            ...
            UrlHelper.parseUrl = function (url) {
                if (!UrlHelper.aspxAnchorElement) {
                    UrlHelper.aspxAnchorElement = UrlHelper.document.createElement('a');
                }
                UrlHelper.aspxAnchorElement.href = url;
                return UrlHelper.aspxAnchorElement;
            };
