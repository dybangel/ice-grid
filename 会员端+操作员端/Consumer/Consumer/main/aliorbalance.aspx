<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aliorbalance.aspx.cs" Inherits="Consumer.main.aliorbalance" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div class="main" style="height:100vh;padding-bottom:10px;">
          ...
          <input type="hidden" id="aLiopenID" runat="server"/>
...
<script>
    ...
    function wxpay()
    {
        ...
        var url = "alipaypage.aspx?companyID=" + $("#_companyID").val() + "&mechineID=" + $("#_mechineID").val() + "&money=" + $("#_money").val() + "&productID=" + $("#_productID").val() + "&dgOrderDetailID=" + $("#_dgOrderID").val() + "&type=" + $("#_type").val();
    ...
    function balancepay()
    {
        ...
        if(confirm("将从您的余额直接扣除"))
        {
            ...
            $.ajax({
                type: "post",
                url: "aliorbalance.aspx/yzPwd",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: "{unionID:'" + $("#aLiopenID").val() + "',money:'" + $("#_money").val() + "',companyID:'" + $("#_companyID").val() + "',productID:'" + $("#_productID").val() + "',mechineID:'" + $("#_mechineID").val() + "',type:'" + $("#_type").val() + "',dgOrderDetailID:'" + $("#_dgOrderID").val() + "',sftj:'" + $("#_sftj").val() + "'}",
