                ...
                <div class="common_main">
                    <div class="navlist">
                        <dl>
                            ...
                            <dd>
                                <a class="change " href="Productform.aspx"><i class="change icolor fa fa-window-restore"></i>商品订单统计</a>
                            </dd>
                             <dd>
                                <a class="change acolor" href="order.aspx"><i class="change icolor fa fa-window-restore"></i>会员订单管理</a>
                            </dd>
                             <dd>
...
<script>
    ...
    function getOrderList() {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: "{bh:'" + $("#bh").val() + "',mechineID:'" + $("#mechineList").val() + "',zq:'" + $("#zqList").val() + "',companyID:'" + $("#companyID").val() + "',pageCurrentCount:'" + $("#pageCurrentCount").val() + "',zt:'" + $("#DropDownList1").val() + "',keywords:'" + $("#keywords").val() + "',start:'" + $("#startTime").val() + "',end:'" + $("#endTime").val() + "'}",
                ...
                for (var i = 0; i < serverdatalist; i++) {
                    ...
                    $(" <li>"
                        ...
                        + "   <span style='width:8%'>" + serverdata[i].phone + "</span>"
                         ...
                         + "   <span style='width:5%'>" + (serverdata[i].orderZT == "4" ? serverdata[i].changebefornum : serverdata[i].syNum) + "天</span>"
