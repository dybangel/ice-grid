                    ...
                    <dl>
                        ...
                        <dd>
                         ...
                         <dd>
                             ...
                             <dd>
                                <a class="change" href="orderlist.aspx"><i class="change fa fa-window-restore"></i>购买记录</a>
                            </dd>
                             <dd>
                                <a class="change acolor" href="paylist.aspx"><i class="change icolor fa fa-window-restore"></i>支付记录</a>
                            </dd>
                         <dd>
...
<script>
    ...
    function getOrderList2() {
        ...
        $(" <li>"
              ...
              + " <label style='width:9%'>会员ID</label>"
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "{'mechineIDList':'" + $("#mechineList").val() + "',companyID:'" + $("#companyID").val() + "',start:'" + $("#start").val() + "',end:'" + $("#end").val() + "',pageCurrentCount:'" + $("#pageCurrentCount").val() + "',selType:'" + $("#selType").val() + "',fkzt:'" + $("#fkzt").val() + "',keyword:'" + $("#keyword").val() + "',trxid:'"+$("#trxid").val()+"'}",
            success: function (data) {
                ...
                for (var i = 0; i < serverdatalist; i++) {
                    ...
                    $(" <li>"
                        ...
                        + "   <span style='width:9%'>" + serverdata[i].memberID + "</span>"
