<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderlist.aspx.cs" Inherits="autosell_center.main.equipment.orderlist" %>
                ...
                <div class="navlist">
                    <dl>
                        <dt>订单管理<em class="fa fa-cog"></em></dt>
                           ...
                           <dd>
                                <a class="change " href="../order/Productform.aspx"><i class="change  fa fa-window-restore"></i>商品订单统计</a>
                            </dd>
                            <dd>
                                <a class="change " href="order.aspx"><i class="change icolor fa fa-window-restore"></i>会员订单管理</a>
                            </dd>
                             <dd>
                                <a class="change acolor" href="orderlist.aspx"><i class="change icolor fa fa-window-restore"></i>购买记录</a>
                            </dd>
                             <dd>
                                <a class="change " href="paylist.aspx"><i class="change  fa fa-window-restore"></i>支付记录</a>
                            </dd>
                            <dd>
                                <a class="change " href="../order/asmldchange.aspx"><i class="change  fa fa-window-restore"></i>库存变动</a>
                            </dd>
                            <dd> 
                                <a class="change"  href="../order/caigoushangpintj.aspx"><i class="change fa fa-window-restore"></i>采购分拣单据</a>
                            </dd>
                              <dd>
                                <a class="change"  href="../order/historylist.aspx"><i class="change fa fa-window-restore"></i>历史清单</a>
                            </dd>
                             <dd>
                                <a class="change"  href="../order/exportOrder.aspx"><i class="change fa fa-window-restore"></i>订购订单导入</a>
                            </dd>
                            <dd>
                                <a class="change "  href="../order/exportOrderhistory.aspx"><i class="change  fa fa-window-restore"></i>订单导入记录</a>
                            </dd>
                            <dd>
                                <a class="change "  href="../order/payCode.aspx"><i class="change  fa fa-window-restore"></i>充值卡列表</a>
                            </dd>
                    </dl>
                </div>
...
<script>
    ...
    function getOrderList() {
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "{'mechineID':'" + $("#mechineList").val() + "',companyID:'" + $("#companyID").val() + "',start:'" + $("#start").val() + "',end:'" + $("#end").val() + "',pageCurrentCount:'" + $("#pageCurrentCount").val() + "',ztlist:'" + $("#ztlist").find("option:selected").text() + "',brandList:'" + $("#brandList").val() + "',selType:'" + $("#selType").val() + "'}",
            success: function (data) {
    ...
    function getOrderList2() {
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "{'mechineID':'" + $("#mechineList").val() + "',companyID:'" + $("#companyID").val() + "',start:'" + $("#start").val() + "',end:'" + $("#end").val() + "',pageCurrentCount:'" + $("#pageCurrentCount").val() + "',ztlist:'" + $("#ztlist").find("option:selected").text() + "',brandList:'" + $("#brandList").val() + "',selType:'" + $("#selType").val() + "',productName:'" + $("#productName").val() + "',idORphone:'" + $("#idORphone").val() + "',orderNO:'" + $("#orderNO").val() + "'}",
            success: function (data) {
                var count = data.d.split('@')[0];
