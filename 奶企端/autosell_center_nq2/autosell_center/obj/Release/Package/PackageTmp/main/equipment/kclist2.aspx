<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kclist2.aspx.cs" Inherits="autosell_center.main.equipment.kclist2" %>
                ...
                <div class="common_main">
                    <div class="navlist">
                        <dl>
                            ...
                            <dd>
                                <a class="change " href="#" onclick="qx_judge('sblb')"><i class="change  fa fa-inbox"></i>设备列表</a>
                            </dd>
                             <dd>
...
<script type="text/javascript">
    ...
    function sear()
    {
        $.ajax({
            type: "post",
            url: "kclist2.aspx/getList",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "{mechineID:'" + $("#mechineID").val() + "'}",
            success: function (data) {
                $(" <li>"
                           + "  <span style='width:50%'>商品</span>"
