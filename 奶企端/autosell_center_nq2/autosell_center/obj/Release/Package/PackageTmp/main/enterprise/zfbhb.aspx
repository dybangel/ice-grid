            ...
            <div class="common_main">
                <div class="navlist">
                        ...
                        <dl>
                            ...
                            <dd>
                               <a class="change" href="#" onclick="qx_judge('mbxx')"><i class="change fa fa-envelope"></i>模板消息</a>
                            </dd>
                        </dl>
                       <dl>
                            <dt>参数设置<em class="fa fa-cog"></em></dt>
                            <dd>
                               <a class="change" href="#" onclick="qx_judge('cssz')"><i class=" fa fa-bars"></i>参数设置</a>
                            </dd>
                        </dl>
                     ...
                     <dl>
                            ...
                            <dd>
                               <a class="change acolor" href="#" onclick="qx_judge('hblist')"><i class=" fa fa-bars"></i>小程序广告图</a>
                            </dd>
                      </dl>
                    </div>
                ...
                <section class="jiqlist">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <input name="act_stop_timeks" autocomplete="off" type="text" id="start"   runat="server" class="ipt" value="" placeholder="有效期开始"  readonly="true"  />
                        <input name="act_stop_timeks" autocomplete="off" type="text" id="end"   runat="server"  class="ipt" value="" placeholder="有效期结束"  readonly="true"  />
                    </form>
