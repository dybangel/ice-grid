                ...
                <div class="common_main">
                    ...
                    <section class="jiqlist">
                        ...
                        <ul class="thepublic">
                            <li>
                                <dl>
                                    <dd>视频设置<span style="color:red">（确保视频在10MB 之内）</span></dd>
                                </dl>
                            </li>
                            <li>
                                <label>视频类型</label>
                            ...
                            <li>
                                <label>视频名称</label>
                                <input type="text" value="" placeholder="请输入视频名称" id="description" maxlength="10"  runat="server"/>
                            </li>
                            <li>
                                <label>视频(mp4;flv)图片(png;jpg)</label>
